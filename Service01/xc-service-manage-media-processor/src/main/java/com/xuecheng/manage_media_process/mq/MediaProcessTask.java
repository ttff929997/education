...
public class MediaProcessTask {
    ...
    //ffmpeg绝对路径
    @Value("${xcServiceManageMedia.ffmpegPath}")
    String ffmpeg_path;
    //上传文件根目录
    @Value("${xcServiceManageMedia.videoLocation}")
    String serverPath;
    @Autowired
    MediaFileRepository mediaFileRepository;

    //接收视频处理消息进行视频处理
    @RabbitListener(queues="${xcServiceManageMedia.mq.queueMediaVideoProcessor}",containerFactory = "customContainerFactory")
